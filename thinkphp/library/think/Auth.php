...
CREATE TABLE `think_auth_rule` (
    ...
    `name` char(80) NOT NULL DEFAULT '', #规则唯一标识
    `title` char(20) NOT NULL DEFAULT '', #规则中文名称
    `type` tinyint(1) NOT NULL DEFAULT '1', 
    `status` tinyint(1) NOT NULL DEFAULT '1', #状态1为正常，0为禁用
...
DROP TABLE IF EXISTS `think_auth_group_access`;
    ...
    `uid` mediumint(8) unsigned NOT NULL, #用户id
    `group_id` mediumint(8) unsigned NOT NULL, #用户组id
